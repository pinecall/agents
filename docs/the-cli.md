...
| `ui [agent]` | the console on 127.0.0.1 for the life of the command, opened in this machine's browser. Chat talks to the class of this directory in writing, Calls → Simulate puts a persona on the line from the page, and Evals → Run a suite ticks the goldens to run | yes |
