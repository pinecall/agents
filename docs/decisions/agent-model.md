...
state change (`src/agent/tools.ts`, `visibleToolsOf`), and when the list it
...
its own tools. Gating is the norm until somebody measures the other one: a matrix run
