...
The gate is CI, on a sandbox token, before the deploy — `pinecall test` (ring 1), `pinecall
knowledge eval`, `pinecall remember`, `pinecall memory eval` — each exits 1 when something did not
