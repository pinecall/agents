...
describe("the gateway's console", () => {
  it("looks at production, and runs the org", () => {
    ...
    expect(names(ORG_SCREENS, "hosted")).toEqual(["Home", "Overview", "Live", "Sessions", "Evals", "Memory", "Usage", "Numbers", "Keys", "Providers", "Team"]);
  });
...
describe("a machine's own console", () => {
  it("looks at the sandbox, and has none of the org's accounts", () => {
    ...
    expect(names(ORG_SCREENS, "local")).toEqual(["Home", "Overview", "Live", "Sessions", "Evals", "Memory", "Phone testing"]);
  });
