/** Docs: the documents this agent searches — the folder pushed from here, the bases, and the golden. */
 ...
 * dropped — and two are the holding process's own, because pushing reads `docs/<name>/` off that
 * machine's disk and the golden in the goldens folder. It is `pinecall docs` with the same defaults.
 */
